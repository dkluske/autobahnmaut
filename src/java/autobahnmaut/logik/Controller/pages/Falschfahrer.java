 ...
 * @author Andi
 */
@WebServlet(name = "falschfahrer", urlPatterns = {"/falschfahrer"})
public class Falschfahrer extends HttpServlet {
...
//        Wenn Nutzer hat KEIENN login, zurück zu
            ...
            if (this.rolle.equals("Admin") || this.rolle.equals("Polizei")) {
                request.getRequestDispatcher("/jsp/falschfahrer.jsp").forward(request, response);
            }else{
//                Permission denied!
